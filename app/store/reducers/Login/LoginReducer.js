...
import {
  LOGIN_SUCCESS, LOGIN_ERROR, LOGOUT_ERROR, LOGOUT_SUCCESS, TOKEN_UNVALID
...
export default function login(state = initialState.login, action) {
  switch (action.type) {
    ...
    case LOGIN_ERROR:
      return {
        ...state, logged: false, id_user: null, token: null
      };
    case LOGOUT_SUCCESS:
      return {
        ...state, logged: false, id_user: null, token: null, director: null
      };
    case LOGOUT_ERROR:
      return state;
    case TOKEN_UNVALID:
