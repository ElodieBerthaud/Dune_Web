        ...
        <div>
          <Card className={classes.card} classes={{ root: classes.card }} style={{ backgroundColor: '#f6ecf8' }}>
            ...
            <CardContent style={{ padding: '0', margin: '1%' }}>
              ...
              {this.state.value === 2 && <TabContainer>{this.props.isDirector ? <AskedApps /> : <CommingSoon />}</TabContainer>}
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withStyles(dashboardStyle)(StoreApp)));
