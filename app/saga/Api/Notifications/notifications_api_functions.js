...
export function get_nb_notifs_api(datas) {
  const url = api_url_dev+'/notifs/getNbNotifs';
...
export function get_all_notifs_api(datas) {
  const url = api_url_dev+'/notifs/popUpMenu';
...
export function get_a_notif_api(datas) {
  const url = api_url_dev+'/notifs/getNotif/'+datas.idNotif;
...
export function validate_app_api(datas) {
  ...
  const url = api_url_dev+'/store/validating';
...
export function read_notif_api(datas) {
  const url = api_url_dev+'/notifs/read/'+datas.idNotif;
