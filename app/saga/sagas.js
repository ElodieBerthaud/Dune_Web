...
import { getAvis, getNbAvis, addAvis, getUserAvis, updateUserAvis } from './Saga/Views/views_saga_functions';
...
import {get_sub_infos, subscribe} from './Saga/Subs/Subscribe';
import {access_facturation, addPaymentMethod} from './Saga/Payments/payments_saga_functions';
import {help} from './Saga/help/help';
...
export function* watcherSaga() {
  ...
  yield takeEvery('ACCESS_PAYMENT_INFOS_REQUEST', access_facturation);
  yield takeEvery('GET_USER_AVIS', getUserAvis);
  yield takeEvery('UPDATE_AVIS_REQUEST', updateUserAvis);
  yield takeEvery('ADD_METHOD_REQUEST', addPaymentMethod);
  yield takeEvery('SUBSCRIBE_ABO_REQUEST', subscribe);
  yield takeEvery('SEND_MESSAGE', help);
}
