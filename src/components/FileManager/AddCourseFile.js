    ...
    getStepContent = (step, classes) => {
        switch (step) {
            ...
            case 2:
                return <div>
                    <p>
                        Choisissez le fichier que vous voulez ajouter a votre espace. Vous pouvez choisir de le rendre privé en cochant la case "fichier privé". Sinon, le fichier sera automatiquement partagé pour tout l'école.</p>
...
const mapDispatchToProps = dispatch => {
    return {
            ...
            AddFile: (token, fileName, description, prive, fileUser, fileType) => dispatch({type: "UPLOAD_FILE_REQUEST", token, fileName, description, prive, fileUser, fileType})
    };
};
