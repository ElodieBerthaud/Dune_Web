...
function change_password_api(datas){
    ...
    return axios({
        method: 'post',
        url: 'http://176.31.252.134:7001/api/v1/login/reset',
        data: datasTosend
    })
}
...
function verify_token_api(datas){
    ...
    return axios({
        method: 'post',
        url: 'http://176.31.252.134:7001/api/v1/tokens/verifyToken',
        data: datasTosend
    });
...
function buy_app_api(datas){
    ...
    const url = "http://176.31.252.134:7001/api/v1/store/buyAppDirecteur";
...
function get_nbr_avis_api(datas){

    const url = "http://176.31.252.134:7001/api/v1/store/nbAvis/" + datas.idGame;
