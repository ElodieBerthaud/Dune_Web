...
class AddStudent extends React.Component {
    ...
    getStepContent = (step, classes) => {
        switch (step) {
            case 0:
                return <div> <p> Choisissez la classe dans laquelle vous voulez ajouter un eleve.</p>
            ...
            case 1:
                return <div> <p> Remplissez les champs ci-dessous </p>
                    ...
                    ;
            case 2:
                return <div> <p> Vous pouvez ajouter une photo au profil. Cela n'est pas obligatoire mais fortement consseille pour la gestion de votre espace. </p>
                    <FormControl  className={classes.formControl} style={{margin: '3%'}}>
                    <Avatar
                                    alt="Adelle Charles"
    ...
    handleNext = () => {
        ...
        if (this.state.activeStep === 0){
            if (this.state.classeName === 0){
                ...
                var elem = document.getElementsByName( 'classeName' );
    ...
    handleSelect = () => {
        ...
        const file_obj = this.state.picElevePrev[0];

        this.setState({picEleveSend: file_obj});
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        addStudent: (token, directorId, idClasse, nom, prenom, picEleve) => dispatch({ type: "ADD_ELEVE_REQUEST", token, directorId, idClasse, nom, prenom, picEleve}),
    };
};
